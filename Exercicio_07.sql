...
SUM(FUNCIONARIO.SALARIO) AS SALARIOS_TOTAL, 
...
SELECT
DEPARTAMENTO.NOME,
COUNT(FUNCIONARIO.NOME) AS DEPARTAMENTO_TOTAL
FROM FUNCIONARIO
...
FUNCAO.IDFUNCAO,
FUNCAO.NOME,
SUM(FUNCIONARIO.SALARIO) AS SALARIO_TOTAL,
MAX(FUNCIONARIO.SALARIO) AS MAIOR_SALARIO,
MIN(FUNCIONARIO.SALARIO) AS MENOR_SALARIO_DPTO
FROM
FUNCIONARIO 
INNER JOIN FUNCAO ON
FUNCAO.IDFUNCAO = FUNCIONARIO.IDFUNCAO
