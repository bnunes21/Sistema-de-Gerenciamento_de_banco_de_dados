...
SELECT 
    CLIENTE.SEXO, 
    COUNT(CLIENTE.IDCLIENTE) AS QTD_CLIENTES
FROM CLIENTE
GROUP BY 
CLIENTE.SEXO;
...
SELECT 
PRODUTO.CATEGORIA,
COUNT(PRODUTO.IDPRODUTO) AS QTDE_PRODUTOS, 
...
SUM(ITEM_PEDIDO.QTDE) AS QUANTIDADE_TOTAL_VENDIDA,
...
PRODUTO.NOME,
ITEM_PEDIDO.PRECO_UNITARIO,
(ITEM_PEDIDO.QTDE*ITEM_PEDIDO_UNITARIO) AS TOTAL
FROM PEDIDO
INNER JOIN CLIENTE
    ON CLIENTE.IDCLIENTE = PEDIDO.IDCLIENTE
